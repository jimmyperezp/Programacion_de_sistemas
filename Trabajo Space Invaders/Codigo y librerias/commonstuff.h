...
#define ALIEN_SPEED 0.002 //se ha reducido la velocidad de lo alienigenas para facilitar el juego
#define OVNI_SPEED 0.01 //se ha aumentado la velocidad del ovni para dificular el darle
#define BULLETSPEED 0.05
#define NUMALIENS 60
#define NUMROWS 5
#define NUMCOLS 12
#define MAXSHOTTIME 1000
#define GRAV -9.8
#define BOUNCE_SPEED 0.25
#define MAXOVNITIME 2500  //definicion del maximo del contador de tiempo de la aparicion del OVNI
